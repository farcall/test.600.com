...
<meta name="copyright" content="ShopEx Incn. All Rights Reserved" />
...
<div id="site-nav" class="w-full">
   <div class="shoptop w clearfix">
      ...
      <ul class="quick-menu">
        <?php if (! $this->_var['index']): ?><li class="home"><a href="<?php echo $this->_var['site_url']; ?>">back_home</a></li><?php endif; ?>
        <li class="item">
