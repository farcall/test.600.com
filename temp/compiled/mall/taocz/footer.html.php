<div id="footer" class="w-full">
   <div class="foot-copyright">Copyright &copy; 2011-2014 <a href="http://www.vchuang.cn">微创动力</a> 版权所有 <?php if ($this->_var['icp_number']): ?><?php echo $this->_var['icp_number']; ?><?php endif; ?> <?php echo $this->_var['statistics_code']; ?></div>
...
?>
            ...
            <div class="mainbox ob3"><a style="text-decoration:none;" href="http://wpa.qq.com/msgrd?v=3&uin=361818525&site=qq&menu=yes" target="_blank"><b></b><span>在线客服</span><div class="clr"></div></a></div>
            <div class="mainbox ob4"><a style="text-decoration:none;" href="http://vchuangcn.taobao.com" target="_blank"><b></b><span>关注微博</span><div class="clr"></div></a></div>
