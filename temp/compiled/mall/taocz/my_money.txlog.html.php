...
<div class="content">
    ...
    <div id="right">
          <ul class="tab">
				<li class="normal"><a href="?app=my_money&act=txlist">提现申请</a></li>
            ...
            <div class="public table">
                ...
                <form method="get">
                  <select name="select">
                    ...
                    <input type="text" class="text1 width8" name="order_sn" value="">
...
?>
                    <?php if (($this->_foreach['v']['iteration'] == $this->_foreach['v']['total'])): ?><tr class="line_bold"><?php else: ?><tr class="line"><?php endif; ?>
                        ...
                        <td align="center"><?php if ($this->_var['val']['order_sn'] == 0): ?>等待通知<?php else: ?><?php echo $this->_var['val']['order_sn']; ?><?php endif; ?></td>
						<td align="center"><?php echo $this->_var['val']['money_zs']; ?>元</td>
