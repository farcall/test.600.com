...
/*下面字体大小记得要删掉*/
.divs{margin:0;text-align:center;over-flow:hidden;height:100%;width:820px;}
...
/* TAB 切换效果 */
.tb_{background-image: url('<?php echo $this->_var['site_url']; ?>/themes/mall/default/styles/default/images_sft/cashier.payment_1.gif'); background-repeat: repeat-x;background-color: #ffffff;}/*按钮底色   图片：上行一横*/
.tb_ ul{height:24px;}
.tb_ li{float:left;height: 24px;line-height:1.9;width: 94px;cursor:pointer;}
/* 用于控制显示与隐藏的css类 */
.normaltab   { background-image:url('<?php echo $this->_var['site_url']; ?>/themes/mall/default/styles/default/images_sft/cashier.payment_2.gif'); background-repeat: no-repeat; color:#f5f5f5 ;}/*无选时字体颜色 图片：无选时图片*/
.hovertab    { background-image: url('<?php echo $this->_var['site_url']; ?>/themes/mall/default/styles/default/images_sft/cashier.payment_3.gif'); background-repeat: no-repeat; color:#ff6600; font-weight:bold }/*已选时字体颜色*/
.dis{display:block;}
.undis{display:none;}
...
<?php echo $this->_var['val']['money']; ?>
                    ...
                    <dd>
                        ...
                        <p class="logo"><label for="payment_sft"><img src="<?php echo $this->_var['site_url']; ?>/themes/mall/default/styles/default/images_sft/logo.gif" alt="shangfutongzhifu" title="商付通支付" width="125" height="47" /></label></p>
...
<?php endif; ?>
            ...
            <div class="make_sure">
                <p>
                    <a href="javascript:$('#zft_pay').submit();" class="btn">确认支付</a>
                </p>
            </div>
