...
<div class="content">
    ...
    <div id="right">
          <ul class="tab">
				...
				<li class="active">卖出查询</li>
				<li class="normal"><a href="index.php?app=my_money&act=intolog">转入查询</a></li>
				<li class="normal"><a href="index.php?app=my_money&act=outlog">转出查询</a></li>
          </ul>
        <div class="wrap">
...
?>
                    <?php if (($this->_foreach['v']['iteration'] == $this->_foreach['v']['total'])): ?><tr class="line_bold"><?php else: ?><tr class="line"><?php endif; ?>
                        ...
                        <td align="center"><a href="index.php?app=seller_order&act=view&order_id=<?php echo $this->_var['val']['order_id']; ?>" target="_blank"><?php echo $this->_var['val']['order_sn']; ?></a></td>
