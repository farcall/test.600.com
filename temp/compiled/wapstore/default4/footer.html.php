...
<div class="lay_footer ">
	<a class="flex_box" href="<?php echo url('app=default'); ?>">商城首页</a>|
    <a class="flex_box" href="<?php echo url('app=store&id=' . $this->_var['store']['store_id']. ''); ?>">商铺首页</a>|
    <a class="flex_box" href="<?php echo url('app=member'); ?>">会员中心</a>
