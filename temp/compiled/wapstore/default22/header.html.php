...
<div class="header">
    <ul class="nav">
        ...
        <a  href="<?php echo url('app=store&id=' . $this->_var['store']['store_id']. '&Debug=Wap'); ?>"> <img src="<?php echo $this->_var['store']['store_logo']; ?>" height="40"></a>
        <a href="<?php echo url('app=cart&Debug=Wap'); ?>"><li><span><img src="<?php echo $this->res_base . "/" . 'images/nav_4.png'; ?>"></span></li></a>
        <a href="<?php if ($this->_var['visitor']['user_id']): ?><?php echo url('app=buyer_order&Debug=Wap'); ?><?php else: ?><?php echo url('app=member&act=login&ret_url=' . $this->_var['ret_url']. '&Debug=Wap'); ?><?php endif; ?>"><li><span><img src="<?php echo $this->res_base . "/" . 'images/nav_3.png'; ?>"></span></li></a>
