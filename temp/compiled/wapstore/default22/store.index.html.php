...
?>
  ...
  <?php endif; ?>
	 ...
	 <?php if ($this->_var['spike_list']): ?>
<h2 class="tuan-title">最新秒杀</h2>
<div class="tuan_box swipe">
    <ul class="tuan_list"  id="slider2">
       <?php $_from = $this->_var['spike_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'group');if (count($_from)):
    foreach ($_from AS $this->_var['group']):
?>
    	
            <li>
            <a href="<?php echo url('app=spike&id=' . $this->_var['group']['group_id']. '&Debug=Wap'); ?>">
                <div class="con">
                    <div class="tuan_imgbox">
                        <img src="<?php echo $this->_var['group']['default_image']; ?>">
                        <p><?php echo htmlspecialchars($this->_var['group']['group_name']); ?></p>
                    </div>
                    <span class="tuan_price">秒杀价：<strong><?php echo price_format($this->_var['group']['group_price']); ?></strong></span>
                     <?php if ($this->_var['group']['state'] == 1): ?>
                    <span class="s_time"><img src="<?php echo $this->res_base . "/" . 'images/time.png'; ?>">剩余：<?php echo $this->_var['group']['lefttime']; ?></span>
                     <?php elseif ($this->_var['group']['state'] == 2): ?>
                    <span class="s_time">活动已结束</span>
      ...
      <span onClick="t2.prev();" class="prenext pre"></span>
    <span onClick="t2.next();" class="prenext next"></span>
</div>
  <?php endif; ?>

  <?php if ($this->_var['recommended_goods']): ?>
<div class="lists">
    <h2><span>橱窗推荐</span><a href="index.php?app=store&act=search&id=<?php echo $this->_var['store']['store_id']; ?>&recommended=1">more<img src="<?php echo $this->res_base . "/" . 'images/hs.png'; ?>"></a></h2>
    <ul>
...
?>
        <a href="<?php echo url('app=goods&id=' . $this->_var['rgoods']['goods_id']. '&Debug=Wap'); ?>">
            <li>
                ...
                <span><?php echo price_format($this->_var['rgoods']['price']); ?><i>    <?php if ($this->_var['rgoods']['cost_price'] == '0'): ?><?php echo price_format($this->_var['rgoods']['price']); ?>   <?php else: ?><?php echo price_format($this->_var['rgoods']['cost_price']); ?><?php endif; ?></i></span>
            </li>
        </a>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    </ul>
...
<div class="lists">
    <h2><span>新品上市</span><a href="index.php?app=store&act=search&id=<?php echo $this->_var['store']['store_id']; ?>&order=add_time">more<img src="<?php echo $this->res_base . "/" . 'images/hs.png'; ?>"></a></h2>
    <ul>
...
?>
        <a href="<?php echo url('app=goods&id=' . $this->_var['ngoods']['goods_id']. '&Debug=Wap'); ?>">
            <li>
                ...
                <span><?php echo price_format($this->_var['ngoods']['price']); ?><i> <?php if ($this->_var['ngoods']['cost_price'] == '0'): ?><?php echo price_format($this->_var['ngoods']['price']); ?>   <?php else: ?><?php echo price_format($this->_var['ngoods']['cost_price']); ?><?php endif; ?></i></i></span>
            </li>
        </a>
         <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    </ul>
