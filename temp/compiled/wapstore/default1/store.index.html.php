...
?>
        ...
        <div class="sort">
            <ul>
                <a href="<?php echo url('app=store&act=search&id=' . $this->_var['store']['store_id']. '&order=add_time desc'); ?>">
                    <li>
                ...
                <a href="<?php echo url('app=store&act=search&id=' . $this->_var['store']['store_id']. '&recommended=1'); ?>">
                    <li>
                ...
                <a href="<?php echo url('app=store&act=search&id=' . $this->_var['store']['store_id']. '&order=views desc'); ?>">
                    <li>
...
?>
        ...
        <div class="lists">
            <h2>橱窗推荐<a href="<?php echo url('app=store&act=search&id=' . $this->_var['store']['store_id']. '&recommended=1'); ?>">more+</a></h2>
            <ul>
...
?>
        ...
        <div class="lists">
            <h2>新品上市<a href="<?php echo url('app=store&act=search&id=' . $this->_var['store']['store_id']. '&order=add_time desc'); ?>">more+</a></h2>
            <ul>
