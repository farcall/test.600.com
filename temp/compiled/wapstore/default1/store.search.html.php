...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="paixu">
            ...
            <a href="<?php echo url('app=store&act=search&id=' . $this->_var['store']['store_id']. '&keyword=' . $this->_var['keyword']. '&cate_id=' . $this->_var['cate_id']. '&order=comments desc'); ?>" class="white_btn <?php if ($_GET['order'] | escape == ' sales desc '): ?>cur<?php endif; ?>">销量<i></i></a>
            <a href="<?php echo url('app=store&act=search&id=' . $this->_var['store']['store_id']. '&keyword=' . $this->_var['keyword']. '&cate_id=' . $this->_var['cate_id']. '&order=add_time desc'); ?>" class="white_btn <?php if ($_GET['order'] == ' add_time desc '): ?>cur<?php endif; ?>">新品<i></i></a>
            <a href="<?php echo url('app=store&act=search&id=' . $this->_var['store']['store_id']. '&keyword=' . $this->_var['keyword']. '&cate_id=' . $this->_var['cate_id']. '&order=price desc'); ?>" class="white_btn <?php if ($_GET['order'] | escape == ' price desc '): ?>cur<?php endif; ?>">价格<i></i></a>
            <a href="<?php echo url('app=store&act=search&id=' . $this->_var['store']['store_id']. '&keyword=' . $this->_var['keyword']. '&cate_id=' . $this->_var['cate_id']. '&order=views desc'); ?>" class="white_btn <?php if ($_GET['order'] == ' views desc '): ?>cur<?php endif; ?>">人气<i></i></a>
        </div>
