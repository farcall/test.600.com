...
<link type="text/css" rel="stylesheet" href="<?php echo $this->res_base . "/" . 'css/tao_btn.css'; ?>">
...
?>
        <a href="<?php echo url('app=goods&id=' . $this->_var['rgoods']['goods_id']. '&Debug=Wap'); ?>" class="goods">
            <li>
               <div class="g_box">
...
?>
        <a href="<?php echo url('app=goods&id=' . $this->_var['ngoods']['goods_id']. '&Debug=Wap'); ?>" class="goods">
            <li>
            	<div class="g_box">
