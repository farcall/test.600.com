...
?>
        ...
        <div class="lists">
            <h2>橱窗推荐<a href="index.php?app=store&act=search&id=<?php echo $this->_var['store']['store_id']; ?>&recommended=1">查看更多<img src="<?php echo $this->res_base . "/" . 'images/hs.png'; ?>"></a></h2>
            <ul>
...
?>
                ...
                <a href="<?php echo url('app=goods&id=' . $this->_var['rgoods']['goods_id']. ''); ?>" class="goods">
                    <li>
                        <div class="g_box">
                            <img src="<?php echo $this->_var['site_url']; ?>/<?php echo $this->_var['rgoods']['default_image']; ?>" />
                            <span><?php echo price_format($this->_var['rgoods']['price']); ?></span><i>    <?php if ($this->_var['rgoods']['cost_price'] == '0'): ?><?php echo price_format($this->_var['rgoods']['price']); ?>   <?php else: ?><?php echo price_format($this->_var['rgoods']['cost_price']); ?><?php endif; ?></i>
                        </div>
        ...
        <div class="lists">
            <h2>新品上市<a href="index.php?app=store&act=search&id=<?php echo $this->_var['store']['store_id']; ?>&order=add_time">查看更多<img src="<?php echo $this->res_base . "/" . 'images/hs.png'; ?>"></a></h2>
            <ul>
...
?>
                <a href="<?php echo url('app=goods&id=' . $this->_var['ngoods']['goods_id']. ''); ?>" class="goods">
                    <li>
                        <div class="g_box">
                            <img src="<?php echo $this->_var['site_url']; ?>/<?php echo $this->_var['ngoods']['default_image']; ?>" />
                            <span><?php echo price_format($this->_var['ngoods']['price']); ?></span><i><?php if ($this->_var['ngoods']['cost_price'] == '0'): ?><?php echo price_format($this->_var['ngoods']['price']); ?>   <?php else: ?><?php echo price_format($this->_var['ngoods']['cost_price']); ?><?php endif; ?></i>
                        </div>
