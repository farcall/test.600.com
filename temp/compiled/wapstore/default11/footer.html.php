...
?>
                 <li><a href="<?php echo url('app=store&id=' . $this->_var['store']['store_id']. '&act=search&cate_id=' . $this->_var['child_gcategory']['id']. ''); ?>"><span><?php echo htmlspecialchars($this->_var['child_gcategory']['value']); ?></span></a></li>
