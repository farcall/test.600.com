    ...
    <div class="w320">
        <div class="fixed">
            ...
            <div class="header header2">
                <a href="<?php echo url('app=member'); ?>" class="back2_pre"></a>
                订单详情
            </div>    
        </div>
...
?>
        ...
        <ul class="orderlist orderinfo">
            ...
            <li><b>支付留言</b><span><?php echo htmlspecialchars($this->_var['order']['pay_message']); ?></span></li>
            <?php endif; ?>
            <li><b>下单时间</b><span><?php echo local_date("Y-m-d H:i:s",$this->_var['order']['add_time']); ?></span></li>
        ...
        <ul class="orderlist orderinfo">
            <li><b>买家</b><span><?php echo htmlspecialchars($this->_var['order']['buyer_name']); ?></span></li>
            <li><b>电话号码</b><span><?php echo ($this->_var['order']['phone_tel'] == '') ? '-' : $this->_var['order']['phone_tel']; ?></span></li>
            <li><b>所在地区</b><span><?php echo (htmlspecialchars($this->_var['order']['region_name']) == '') ? '-' : htmlspecialchars($this->_var['order']['region_name']); ?></span></li>
            <li><b>手机号码</b><span><?php echo ($this->_var['order']['phone_mob'] == '') ? '-' : $this->_var['order']['phone_mob']; ?></span></li>
            <li><b>电子邮件</b><span><?php echo ($this->_var['order']['buyer_email'] == '') ? '-' : $this->_var['order']['buyer_email']; ?></span></li>
            <li><b>详细地址</b><span><?php echo (htmlspecialchars($this->_var['order']['address']) == '') ? '-' : htmlspecialchars($this->_var['order']['address']); ?></span></li>
        </ul>
        <ul class="orderlist orderinfo">
...
?>
            <li>
                <b><?php if ($this->_var['log']['operator'] == '0'): ?><?php else: ?><?php echo htmlspecialchars($this->_var['log']['operator']); ?><?php endif; ?></b>
                <span>在<?php echo local_date("Y-m-d H:i:s",$this->_var['log']['log_time']); ?>将订单状态从<?php echo $this->_var['log']['order_status']; ?>改变为<?php echo $this->_var['log']['changed_status']; ?><br/><?php if ($this->_var['log']['remark']): ?>原因:<?php echo htmlspecialchars($this->_var['log']['remark']); ?><?php endif; ?></span>
            </li>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </ul>
        <ul class="orderlist orderinfo">
            ...
            <?php if ($this->_var['order']['postscript']): ?><li ><b style="width:87px">买家附言</b><span><?php echo htmlspecialchars($this->_var['order']['postscript']); ?></span></li> <?php endif; ?>
