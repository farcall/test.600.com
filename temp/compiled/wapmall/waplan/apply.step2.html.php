...
<div class="w320 apply_form">
    <form method="post" enctype="multipart/form-data" id="apply_form">
        ...
        <ul>
            <li>
                <h2>店主姓名</h2>
                <div class="arrange"><input type="text" class="text width7" name="owner_name" value="<?php echo htmlspecialchars($this->_var['store']['owner_name']); ?>"/></div>
            </li>
            <li>
                <h2>身份证号</h2>
                <div class="arrange"><input type="text" class="text width7" name="owner_card" value="<?php echo htmlspecialchars($this->_var['store']['owner_card']); ?>"></div>
            </li>
            <li>
                <h2>店铺名称</h2>
                <div class="arrange"><input type="text" class="text width7" name="store_name" id="store_name" value="<?php echo htmlspecialchars($this->_var['store']['store_name']); ?>"/></div>
            </li>
            <li>
                <h2>所属分类</h2>
                <div class="arrange">
            ...
            <li>
                <h2>详细地址</h2>
                <div class="arrange"><input type="text" class="text width7" name="address" value="<?php echo htmlspecialchars($this->_var['store']['address']); ?>"/></div>
            </li>
            <li>
                <h2>邮政编码</h2>
                <div class="arrange"><input type="text" class="text width7" name="zipcode" value="<?php echo htmlspecialchars($this->_var['store']['zipcode']); ?>"/></div>
            </li>
            <li>
                <h2>联系电话</h2>
                <div class="arrange"><input type="text" class="text width7" name="tel"  value="<?php echo htmlspecialchars($this->_var['store']['tel']); ?>"/></div>
            </li>
            <li>
                <h2>上传证件 </h2>
                <div class="arrange"><input type="file" name="image_1" /><?php if ($this->_var['store']['image_1']): ?><p style="display:inline;"><a href="<?php echo $this->_var['site_url']; ?>/<?php echo $this->_var['store']['image_1']; ?>" target="_blank">查看</a></p><?php endif; ?></div>
            </li>
            <li>
                <h2>上传执照</h2>
                <div class="arrange"><input type="file" name="image_2" /><?php if ($this->_var['store']['image_2']): ?><p style="display:inline;"><a href="<?php echo $this->_var['site_url']; ?>/<?php echo $this->_var['store']['image_2']; ?>" target="_blank">查看</a></p><?php endif; ?></div>
            </li>
            <li>
