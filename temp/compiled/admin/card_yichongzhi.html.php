    ...
    <div class="fontl">
        <form method="get">
            <div class="left">
              ...
              <input name="act" type="hidden" id="act" value="card_yichongzhi" />
              充值卡号:
...
?>
        <tr class="tatr2">
            ...
            <td><a href="index.php?module=my_money&act=card_edit&id=<?php echo $this->_var['val']['id']; ?>">编辑</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:drop_confirm('确定删除吗？', 'index.php?module=my_money&act=card_del&id=<?php echo $this->_var['val']['id']; ?>');">删除</a></td>
        </tr>
        <?php endforeach; else: ?>
        <tr class="no_data">
