...
<div class="mrightTop">
	<div class="fontl">欢迎使用ECmall 短信插件 by http://vchuangcn.taobao.com</div>
</div>
<div id="rightTop">
    <ul class="subnav" style="margin-left:0px;">
        ...
        <li><a class="btn1" href="index.php?module=msg&act=send">短信发送</a></li>
         <li><a class="btn1" href="index.php?module=msg&act=setting">设置</a></li>
    </ul>
</div>
...
?>
                		<input type="checkbox"  readonly="readonly" <?php if ($this->_var['checked_functions'][$this->_var['func']]): ?> checked<?php endif; ?> id="function_<?php echo $this->_var['func']; ?>" /><label for="function_<?php echo $this->_var['func']; ?>">&nbsp;<?php echo $this->_var['lang'][$this->_var['func']]; ?></label>&nbsp;&nbsp;
            		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                    <?php endif; ?>
            </td>
            <td><?php echo $this->_var['val']['num']; ?></td>
            <td><?php echo $this->_var['val']['state']; ?></td>
            <td><a href="index.php?module=msg&act=add&user_id=<?php echo $this->_var['val']['user_id']; ?>&user_name=<?php echo $this->_var['val']['user_name']; ?>">增加短信</a></td>
        </tr>
        <?php endforeach; else: ?>
        <tr class="no_data">
