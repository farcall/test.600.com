...
?> 
			...
			<tr>
                <th class="paddingT15">开户银行地址</th>
                <td class="paddingT15 wordSpacing5"><?php echo $this->_var['val']['bank_add']; ?></td>
            </tr>
			<tr>
			...
			<tr>
                ...
                <td class="paddingT15 wordSpacing5"><?php echo $this->_var['val']['bank_username']; ?></td>
            </tr>
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>	
<?php $_from = $this->_var['log']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'val');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['val']):
