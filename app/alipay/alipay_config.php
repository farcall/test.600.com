...
$seller_email    = "292495245@qq.com";				//签约支付宝账号或卖家支付宝帐户

$_input_charset  = "utf-8";						       //字符编码格式 目前支持 GBK 或 utf-8
$transport       = "http";						       //访问模式,根据自己的服务器是否支持ssl访问，若支持请选择https；若不支持请选择http

$notify_url      = "http://www.17local.com/index.php?app=my_money&act=notify_url";    //交易过程中服务器通知的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
$return_url      = "http://www.17local.com/index.php?app=my_money&act=return_url";    //付完款后跳转的页面 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
$show_url        = "http://www.17local.com/index.php?app=my_money&act=paylist";			   //网站商品的展示地址，不允许加?id=123这类自定义参数
...
$mainname		= "17同城_烟台购物网";							//收款方名称，如：公司名称、网站名称、收款人姓名等
?>